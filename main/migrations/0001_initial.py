    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('design_type', models.CharField(choices=[('2D', '2D'), ('3D', '3D')], max_length=50)),
                ('interior_or_exterior', models.CharField(choices=[('Interior', 'Interior'), ('Exterior', 'Exterior')], max_length=50)),
